...
class Users(AbstractBaseUser, PermissionsMixin):
    ...
    avatar = models.ImageField(upload_to="avatars/", default="media/default.jpeg")
...
class Attendance(models.Model):
    student = models.ForeignKey("Users", on_delete=models.CASCADE, related_name="attendance")
    subject = models.ForeignKey(Subjects, on_delete=models.CASCADE)
...
class Payment(models.Model):
    ...
    student = models.ForeignKey("Users", on_delete=models.CASCADE, related_name="payment")
